...
public class Plagueheart extends BaseRelic {
    private static final String NAME = "Plagueheart"; //The name will be used for determining the image file as well as the ID.
    ...
    public void onPlayCard(AbstractCard c, AbstractMonster m) {
        ...
        playedPickaxe = c.hasTag(CustomTags.PICKAXE);
    }
