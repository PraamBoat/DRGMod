...
public class OmmeronHeartstone extends BaseRelic {
    private static final String NAME = "OmmeronHeartstone"; //The name will be used for determining the image file as well as the ID.
