...
public class PotsOGold extends BaseCard {
    private static final int MAGIC = 5;
    private static final int UPG_MAGIC = 3;

    public static final String ID = makeID(PotsOGold.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(p, p, new PotsOGoldPower(p, magicNumber)));
    }
}
